@empty($penjualan_details)
    ...
    @else
        <form action="{{ url('/detail/' . $penjualan_details->detail_id . '/update_ajax') }}" method="POST" id="form-edit">
            @csrf
            @method('PUT')
            <div id="modal-master" class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="penjualan_id" name="penjualan_id" required>
                                ...
                                @foreach ($penjualan as $item)
                                    <option {{ $item->penjualan_id == $penjualan_details->penjualan->penjualan_id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="barang_id" name="barang_id" required>
                                ...
                                @foreach ($barang as $item)
                                    <option {{ $item->barang_id == $penjualan_details->barang_id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            <label>Harga</label>
                            <input value="{{ $penjualan_details->harga }}" type="text" name="harga" id="harga"
                                class="form-control" required>
                            <small id="error-harga" class="error-text form-text text-danger"></small>
                        </div>
                        <div class="form-group">
                            <label>Jumlah</label>
                            <input value="{{ $penjualan_details->jumlah }}" type="text" name="jumlah" id="jumlah"
                                class="form-control" required>
